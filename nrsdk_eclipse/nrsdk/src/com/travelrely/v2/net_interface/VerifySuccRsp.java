...
public class VerifySuccRsp extends BaseResponse implements Serializable
{
    private static final long serialVersionUID = 1L;

    ResponseInfo responseInfo;
    VerifySuccRsp.Data data;
    ...
    public VerifySuccRsp.Data getData()
    {
        return data;
    }

    public void setData(VerifySuccRsp.Data data)
    {
        this.data = data;
    }
