...
public class LogoutRsp extends BaseResponse implements Serializable
{
    ...
    public LogoutRsp.Data getData()
    {
        return data;
    }

    public void setData(LogoutRsp.Data data)
    {
        this.data = data;
    }
