...
public class RingBuffer4EcPlay {//环形缓冲
	private static final RingBuffer4EcPlay Instance=new RingBuffer4EcPlay(10000);
	...
	public RingBuffer4EcPlay(int memunitCount) {
		// TODO Auto-generated constructor stub
		init(memunitCount);
		Log.e("","ring buffer init!!");
	}
	public static RingBuffer4EcPlay getInstance(){
		return Instance;
	}
