...
public class GetComAdvRsp extends BaseResponse implements Serializable
{
    private static final long serialVersionUID = 1L;

    ResponseInfo responseInfo;

    GetComAdvRsp.Data data;
    ...
    public GetComAdvRsp.Data getData()
    {
        return data;
    }

    public void setData(GetComAdvRsp.Data data)
    {
        this.data = data;
    }
    ...
    public static class Data extends BaseData implements Serializable
    {
        ...
        public void setValue(JSONObject jsonObject)
        {
            ...
            for (int i = 0; i < advListArray.length(); i++)
            {
                ...
                adv.setBig_adv_pic(jsonObject2.optString("com_adv_pic"));
